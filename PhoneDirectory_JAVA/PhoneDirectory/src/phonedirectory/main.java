...
public class main extends javax.swing.JFrame {  
    ...
    try {
               DefaultTableModel model = new DefaultTableModel(new String[]{"Name", "Nickname", "PhoneNumber", "MobileNumber","EmailAddress","HomeAddress","Company","Position","GroupName","Website","FacebookAccount"}, 0);
                ...
                conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/phonedirectory", "root", "Root@123");
    ...
    private static void archive(){
        ...
        Statement st = null;
        try{
            con = DriverManager.getConnection("jdbc:mysql://localhost/phonedirectory","root","Root@123");
            st = con.createStatement();
